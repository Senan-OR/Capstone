...
df = pd.read_csv("/Users/umutburgaz/ZTFWork/a_May_28_new/est_5972.csv")
...
findf = fdf.set_axis(['filename', 'ztfname', 'phase', 'redshift', 'v_x1_5972', 'v_x2_5972'], axis=1, inplace=False)
